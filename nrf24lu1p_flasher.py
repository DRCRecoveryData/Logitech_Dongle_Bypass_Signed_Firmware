...
def program_Device_FAST():
    ...
    spi_transfer(0x00)
    set_cs(CS_DISABLE)
    binPath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'watchman_dongle_combined.bin')
...
if __name__ == "__main__":
    ...
    while eingabe not in ('0', '1'):
        eingabe = input("Invalid input. Please enter either 0 or 1: ")

    if eingabe == "0":
        print("Programming just the BOOT LDR. This takes up to 1min!")
    else:
        print("Programming the full Image. This takes up to 12min! Please be patient.")
